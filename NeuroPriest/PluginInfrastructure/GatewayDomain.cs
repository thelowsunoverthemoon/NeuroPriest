...
namespace Kbg.NppPluginNET.PluginInfrastructure
{
    ...
    public class Cells
    {
        ...
        public char[] Value
        {
            get { return charactersAndStyles; }
        }
    }
    ...
    public class TextRange : IDisposable
    {
        ...
        {
            if (_ptrSciTextRange != IntPtr.Zero)
                _sciTextRange = (Sci_TextRange)
                    Marshal.PtrToStructure(_ptrSciTextRange, typeof(Sci_TextRange));
        }
    ...
    /// <summary>
    /// Transfer the code page used to interpret the bytes of the document as characters.
    ...
    /// <summary>Transfer the alpha used for a marker that is drawn in the text area, not the margin. (Scintilla feature SC_MARGIN_)</summary>
    ...
    /// <summary>Transfer a style to be underlined or not. (Scintilla feature SC_CASE_)</summary>
    ...
    /// <summary>Transfer the other colour used as a chequerboard pattern in the fold margin (Scintilla feature SC_ACCESSIBILITY_)</summary>
    ...
    /// <summary>Transfer which document modification events are sent to the container. (Scintilla feature EDGE_)</summary>
    ...
    /// <summary>Transfer the focus to this Scintilla widget. (Scintilla feature CARET_)</summary>
    ...
    /// <summary>Transfer bidirectional text display state. (Scintilla feature SC_LINECHARACTERINDEX_)</summary>
